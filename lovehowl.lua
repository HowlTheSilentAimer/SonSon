...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart", "RightUpperLeg", "LeftUpperLeg", "RightUpperArm", "LeftUpperArm", "RightLowerArm", "LeftLowerArm"},
...
-- // Howl runs you nigga, steal and ur a bitch